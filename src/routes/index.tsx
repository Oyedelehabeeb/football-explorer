...
export const Route = createFileRoute('/')({
  ...
  head: () => seoHead({ title: 'Football fixtures and scores — Football Explorer', description: 'Explore today’s football fixtures, match status and scores across competitions worldwide.', path: '/' }),
  component: Home,
})
