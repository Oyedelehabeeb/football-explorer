...
export const Route = createFileRoute('/players/')({
  ...
  head: ({ loaderData }) => seoHead({ title: 'Player search — Football Explorer', description: 'Search football players and explore profiles, statistics, careers and honours.', path: loaderData?.query ? `/players?q=${encodeURIComponent(loaderData.query)}` : '/players', noIndex: Boolean(loaderData?.query) }),
